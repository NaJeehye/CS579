...
lexEntry(qnp,[symbol:thing,syntax:[where],mood:int,type:wh]).                     
lexEntry(qnp,[symbol:thing,syntax:[when],mood:int,type:wh]).
...
lexEntry(coord,[syntax:[but],type:disj]).
lexEntry(coord,[syntax:[so],type:disj]).
lexEntry(coord,[syntax:[yet],type:disj]).
...
lexEntry(pi,[symbol:retired,syntax:[retired]]).

/*========================================================================
  to
========================================================================*/

lexEntry(to,[symbol:to,syntax:[to]]).

/*========================================================================
   Appended
========================================================================*/

lexEntry(adj,[symbol:famous,syntax:[famous]]).
lexEntry(noun,[symbol:ceo,syntax:[ceo]]).

lexEntry(prep,[symbol:after,syntax:[after]]).
lexEntry(pn,[symbol:verma,syntax:[verma]]).
lexEntry(tv,[symbol:told,syntax:[told],inf:fin,num:sg]).
lexEntry(tv,[symbol:told,syntax:[told],inf:fin,num:pl]).
lexEntry(tv,[symbol:told,syntax:[told],inf:inf,num:sg]).
lexEntry(tv,[symbol:told,syntax:[told],inf:inf,num:pl]).
lexEntry(iv,[symbol:told,syntax:[told],inf:fin,num:sg]).
lexEntry(iv,[symbol:told,syntax:[told],inf:fin,num:pl]).
lexEntry(iv,[symbol:told,syntax:[told],inf:inf,num:sg]).
lexEntry(iv,[symbol:told,syntax:[told],inf:inf,num:pl]).
lexEntry(noun,[symbol:department,syntax:[department]]).
lexEntry(prep,[symbol:of,syntax:[of]]).
lexEntry(noun,[symbol:personnel,syntax:[personnel]]).
lexEntry(coord,[syntax:[and],type:conj]).
lexEntry(noun,[symbol:training,syntax:[training]]).
lexEntry(prep,[symbol:to,syntax:[to]]).
lexEntry(tv,[symbol:consider,syntax:[consider],inf:fin,num:sg]).
lexEntry(tv,[symbol:consider,syntax:[consider],inf:fin,num:pl]).
lexEntry(tv,[symbol:consider,syntax:[consider],inf:inf,num:sg]).
lexEntry(tv,[symbol:consider,syntax:[consider],inf:inf,num:pl]).
lexEntry(iv,[symbol:consider,syntax:[consider],inf:fin,num:sg]).
lexEntry(iv,[symbol:consider,syntax:[consider],inf:fin,num:pl]).
lexEntry(iv,[symbol:consider,syntax:[consider],inf:inf,num:sg]).
lexEntry(iv,[symbol:consider,syntax:[consider],inf:inf,num:pl]).
lexEntry(adj,[symbol:him,syntax:[him]]).
lexEntry(adj,[symbol:retired,syntax:[retired]]).
lexEntry(noun,[symbol:home,syntax:[home]]).
lexEntry(noun,[symbol:ministry,syntax:[ministry]]).
lexEntry(tv,[symbol:asked,syntax:[asked],inf:fin,num:sg]).
lexEntry(tv,[symbol:asked,syntax:[asked],inf:fin,num:pl]).
lexEntry(tv,[symbol:asked,syntax:[asked],inf:inf,num:sg]).
lexEntry(tv,[symbol:asked,syntax:[asked],inf:inf,num:pl]).
lexEntry(iv,[symbol:asked,syntax:[asked],inf:fin,num:sg]).
lexEntry(iv,[symbol:asked,syntax:[asked],inf:fin,num:pl]).
lexEntry(iv,[symbol:asked,syntax:[asked],inf:inf,num:sg]).
lexEntry(iv,[symbol:asked,syntax:[asked],inf:inf,num:pl]).
lexEntry(tv,[symbol:join,syntax:[join],inf:fin,num:sg]).
lexEntry(tv,[symbol:join,syntax:[join],inf:fin,num:pl]).
lexEntry(tv,[symbol:join,syntax:[join],inf:inf,num:sg]).
lexEntry(tv,[symbol:join,syntax:[join],inf:inf,num:pl]).
lexEntry(iv,[symbol:join,syntax:[join],inf:fin,num:sg]).
lexEntry(iv,[symbol:join,syntax:[join],inf:fin,num:pl]).
lexEntry(iv,[symbol:join,syntax:[join],inf:inf,num:sg]).
lexEntry(iv,[symbol:join,syntax:[join],inf:inf,num:pl]).
lexEntry(noun,[symbol:work,syntax:[work]]).
lexEntry(prep,[symbol:on,syntax:[on]]).
lexEntry(adj,[symbol:last,syntax:[last]]).
lexEntry(noun,[symbol:day,syntax:[day]]).
lexEntry(noun,[symbol:his,syntax:[his]]).
lexEntry(adj,[symbol:fixed,syntax:[fixed]]).
lexEntry(noun,[symbol:tenure,syntax:[tenure]]).
lexEntry(prep,[symbol:as,syntax:[as]]).
lexEntry(noun,[symbol:thursday,syntax:[thursday]]).
lexEntry(tv,[symbol:directed,syntax:[directed],inf:fin,num:sg]).
lexEntry(tv,[symbol:directed,syntax:[directed],inf:fin,num:pl]).
lexEntry(tv,[symbol:directed,syntax:[directed],inf:inf,num:sg]).
lexEntry(tv,[symbol:directed,syntax:[directed],inf:inf,num:pl]).
lexEntry(iv,[symbol:directed,syntax:[directed],inf:fin,num:sg]).
lexEntry(iv,[symbol:directed,syntax:[directed],inf:fin,num:pl]).
lexEntry(iv,[symbol:directed,syntax:[directed],inf:inf,num:sg]).
lexEntry(iv,[symbol:directed,syntax:[directed],inf:inf,num:pl]).
lexEntry(noun,[symbol:dg,syntax:[dg]]).
lexEntry(noun,[symbol:removal,syntax:[removal]]).
lexEntry(noun,[symbol:cbi,syntax:[cbi]]).
lexEntry(noun,[symbol:chief,syntax:[chief]]).
